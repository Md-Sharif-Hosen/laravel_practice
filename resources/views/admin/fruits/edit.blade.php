                    ...
                    <form action="{{route('dashboard.fruite.update',$editdata->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card_header d-flex flex-wrap gap-3 justify-content-between p-4">
                                <h2>student Edit</h2>
                                 <a href="{{route('dashboard.fruite.index')}}" class="btn btn-outline-info"> <i class="fa fa-arrow-left">Back</i></a>
                            </div>
                            <div class="card-body">

                                    <div class="from-group col-md-6">
                                        <label for="">Name</label>
                                        <input value="{{$editdata->name}}" type="text" name="fruits_name" class="form-control" />
                                        @error('name')
